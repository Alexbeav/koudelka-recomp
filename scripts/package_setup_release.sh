...
#
# Writes: dist/Koudelka-Recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix Koudelka-Recomp \
  --exe-name Koudelka_Recompiled \
  --display-name "Koudelka Recompiled" \
  --recompiler-build "${RECOMPILER_BUILD}" \
  --version-env RELEASE_VERSION \
  --disc-hint "your legally owned Koudelka disc" \
