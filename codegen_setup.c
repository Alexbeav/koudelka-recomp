...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Koudelka",
    .project_root_env = "KOUDELKA_RECOMP_PROJECT_ROOT",
    .build_dir_env = "KOUDELKA_RECOMP_BUILD_DIR",
    .force_setup_env = "KOUDELKA_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_028.97_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Koudelka__Recompiled",
    .prepare_note =
