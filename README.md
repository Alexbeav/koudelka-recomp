...
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/koudelka-recomp)](https://github.com/Alexbeav/koudelka-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->
...
Zip prefix for CI artifacts: `Koudelka-Recomp`.
...
The `v0.3.3` source uses `Koudelka_Recompiled` in CMake, the setup relaunch, and the packager.
